    ...
    <div class="dashboard-grid">
        <div class="dashboard-left">
            ...
            <div class="action-boxes-container">
                ...
                <div class="action-box"
                    onclick="switchTab('student-site-supervisor', document.getElementById('nav-item-student-site-supervisor'))">
                    <div class="action-icon-wrapper">
                        <i class="fa-solid fa-user-tie"></i>
                    </div>
                    <h3>Site Supervisor Details</h3>
                    <p>View your assigned placement organization, contact person, and site supervisor contact
                        information.</p>
                </div>
        ...
        <div class="student-profile-sidebar">
            ...
            <div style="display: flex; align-items: center; justify-content: center; gap: 8px;">
                ...
                <button type="button" onclick="togglePasswordVisibility()"
                    ...
                    <span
                        style="display: inline-flex; align-items: center; justify-content: center; background-color: #198754; color: #ffffff; width: 26px; height: 26px; border-radius: 50%;">
            ...
            <div class="info-card-body">
                <form action="" method="POST">
                    <div class="info-row">
                        ...
                        <div class="info-value">
                            <input type="text" id="name" name="name"
                                ...
                                data-original="<?php echo htmlspecialchars($profile['name'] ?? ''); ?>" required
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-value">
                            <input type="text" id="fname" name="fname"
                                ...
                                data-original="<?php echo htmlspecialchars($profile['fname'] ?? ''); ?>" required
                                readonly class="info-input-field">
                        </div>
                    </div>
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-value">
                            <input type="text" id="cnic" name="cnic"
                                ...
                                data-original="<?php echo htmlspecialchars($profile['cnic'] ?? ''); ?>" required
                                readonly class="info-input-field">
                        </div>
                    </div>
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-value">
                            <input type="text" id="session" name="session"
                                value="<?php echo htmlspecialchars($semesterDetail['session'] ?? ''); ?>"
                                data-original="<?php echo htmlspecialchars($semesterDetail['session'] ?? ''); ?>"
                                required readonly class="info-input-field">
                        </div>
                    </div>
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-value">
                            <input type="text" id="department" name="department"
                                value="<?php echo htmlspecialchars($semesterDetail['department'] ?? ''); ?>"
                                data-original="<?php echo htmlspecialchars($semesterDetail['department'] ?? ''); ?>"
                                required readonly class="info-input-field">
                        </div>
                    </div>
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-value">
                            <input type="text" id="program" name="program"
                                value="<?php echo htmlspecialchars($semesterDetail['program'] ?? ''); ?>"
                                data-original="<?php echo htmlspecialchars($semesterDetail['program'] ?? ''); ?>"
                                required readonly class="info-input-field">
                        </div>
                    </div>
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-value">
                            <input type="text" id="semester" name="semester"
                                value="<?php echo htmlspecialchars($semesterDetail['semester'] ?? ''); ?>"
                                data-original="<?php echo htmlspecialchars($semesterDetail['semester'] ?? ''); ?>"
                                required readonly class="info-input-field">
                        </div>
                    </div>
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-value">
                            <input type="text" id="batch" name="batch"
                                ...
                                data-original="<?php echo htmlspecialchars($semesterDetail['batch'] ?? ''); ?>" readonly
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-value">
                            <input type="text" id="section" name="section"
                                ...
                                data-original="<?php echo htmlspecialchars($semesterDetail['section'] ?? ''); ?>"
                                readonly class="info-input-field">
                        </div>
                    </div>
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-value">
                            <input type="date" id="dob" name="dob"
                                ...
                                data-original="<?php echo htmlspecialchars($profile['dob'] ?? ''); ?>" readonly
                                class="info-input-field">
                        </div>
                    </div>
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-value">
                            <input type="text" id="cellno" name="cellno"
                                value="<?php echo htmlspecialchars($profile['cell_no'] ?? ''); ?>"
                                data-original="<?php echo htmlspecialchars($profile['cell_no'] ?? ''); ?>" required
                                readonly class="info-input-field">
                        </div>
                    </div>
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-value">
                            <input type="email" id="email" name="email"
                                ...
                                data-original="<?php echo htmlspecialchars($profile['email'] ?? ''); ?>" required
                                readonly class="info-input-field">
                        </div>
                    </div>
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-value">
                            <input type="text" id="city" name="city"
                                ...
                                data-original="<?php echo htmlspecialchars($profile['city'] ?? ''); ?>" readonly
                                class="info-input-field">
                        </div>
                    </div>
                    ...
                    <div class="info-row" style="align-items: flex-start;">
                        ...
                        <div class="info-value">
                            <textarea id="address" name="address" rows="2" class="info-input-field" readonly
                                style="resize: vertical;"
                                data-original="<?php echo htmlspecialchars($profile['address'] ?? ''); ?>"><?php echo htmlspecialchars($profile['address'] ?? ''); ?></textarea>
                        </div>
                    </div>

                    <div id="edit-btn-container" style="text-align: right; margin-top: 20px;">
                        <button type="button" onclick="enableEditMode()" class="btn-save-info"
                            style="background: linear-gradient(135deg, #2e6652 0%, #26294d 100%);">Edit Profile</button>
                    </div>
                    <div id="save-btn-container"
                        style="display: none; justify-content: flex-end; gap: 10px; margin-top: 20px;">
                        <button type="button" onclick="disableEditMode()" class="btn-cancel"
                            style="margin-top: 0; padding: 10px 20px;">Cancel</button>
                        <button type="submit" name="save_student_dashboard" class="btn-save-info"
                            style="margin-top: 0;">Save Information</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="table-header-bar">
        ...
        <?php else: ?>
            <div class="btn-primary-action"
                style="background-color: #94a3b8; cursor: default; opacity: 0.7; pointer-events: none;">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <?php else: ?>
                                <button class="btn-table-action" disabled
                                    style="background-color: #94a3b8; cursor: not-allowed; opacity: 0.7;">
...
<div id="student-site-supervisor" class="tab-content">
    <div class="table-header-bar">
        <button class="btn-primary-action" onclick="openModal('placementModal')"
            style="background: linear-gradient(135deg, #2e6652 0%, #26294d 100%);">
            <i class="fa-solid fa-pen-to-square"></i>
            <?php echo empty($placement['org_name']) ? 'Insert Site Supervisor Details' : 'Edit Placement Details'; ?>
        </button>
    </div>
        ...
        <div class="card-body">
            <?php if (empty($placement['org_name'])): ?>
                <div style="text-align: center; color: #64748b; padding: 30px;">
                    ...
                    No internship placement or site supervisor has been assigned to you yet. Please click the button above
                    to insert your details.
                </div>
            <?php else: ?>
                    ...
                    <div class="org-details-grid"
                        ...
                        <div class="org-detail-block"
                            ...
                            <p style="margin-bottom: 6px;"><strong>Designation:</strong>
                                <?php echo htmlspecialchars($placement['contact_person_designation'] ?? 'N/A'); ?></p>
                            <p style="margin-bottom: 6px;"><strong>Cell No:</strong>
                                <?php echo htmlspecialchars($placement['contact_person_phone'] ?? 'N/A'); ?></p>
                            <p style="margin-bottom: 6px;"><strong>Email:</strong>
                                <?php echo htmlspecialchars($placement['contact_person_email'] ?? 'N/A'); ?></p>
                        </div>
                        ...
                        <div class="org-detail-block"
                            ...
                            <p style="margin-bottom: 6px;"><strong>Designation:</strong>
                                <?php echo htmlspecialchars($placement['site_supervisor_designation'] ?? 'N/A'); ?></p>
                            <p style="margin-bottom: 6px;"><strong>Cell No:</strong>
                                <?php echo htmlspecialchars($placement['site_supervisor_phone'] ?? 'N/A'); ?></p>
                            <p style="margin-bottom: 6px;"><strong>Email:</strong>
                                <?php echo htmlspecialchars($placement['site_supervisor_email'] ?? 'N/A'); ?></p>
                        </div>
...
<!-- ========================================== -->
<div id="student-change-password" class="tab-content"
    style="background-color: #e3efea; padding: 20px; border-radius: 6px;">
    ...
    <div class="student-profile-wrapper" style="margin-top: 0;">
        ...
        <div class="student-profile-main" style="border: 1px solid #c2dbd0;">
            <div class="info-card-header"
                style="background: linear-gradient(135deg, #2e6652 0%, #26294d 100%); padding: 14px 20px;">Reset
                Password</div>
            <div class="info-card-body" style="padding: 25px 20px;">
                <form action="" method="POST" id="change-password-form">

                    <div class="info-row" style="margin-bottom: 20px;">
                        <label class="info-label" style="width: 25%; font-weight: bold; color: #2e6652;"
                            for="old_password">Old Password</label>
                        <div class="info-value" style="width: 75%; position: relative;">
                            <input type="password" id="old_password" name="old_password" required
                                class="info-input-field"
                                style="background-color: #ffffff; border: 1px solid #cbd5e1; padding-right: 40px; width: 100%;"
                                placeholder="Old Password">
                            <span onclick="toggleFieldPassword('old_password', this)"
                                style="position: absolute; right: 12px; top: 50%; transform: translateY(-50%); cursor: pointer; color: #dc3545; display: inline-flex; align-items: center;">
                    ...
                    <div class="info-row" style="margin-bottom: 8px;">
                        ...
                        <div class="info-value" style="width: 75%; position: relative;">
                            <input type="password" id="new_password" name="new_password" required
                                class="info-input-field"
                                style="background-color: #ffffff; border: 1px solid #cbd5e1; padding-right: 40px; width: 100%;"
                                placeholder="New Password" oninput="validateNewPassword()">
                            <span onclick="toggleFieldPassword('new_password', this)"
                                style="position: absolute; right: 12px; top: 50%; transform: translateY(-50%); cursor: pointer; color: #dc3545; display: inline-flex; align-items: center;">
                                <i class="fa-solid fa-eye" style="font-size: 14px;"></i>
                            </span>
                        </div>
                    ...
                    <div class="info-row" style="margin-bottom: 20px;">
                        ...
                        <div class="info-value"
                            style="width: 75%; font-size: 12.5px; color: #64748b; line-height: 1.5;">
                    ...
                    <div class="info-row" style="margin-bottom: 25px;">
                        ...
                        <div class="info-value" style="width: 75%; position: relative;">
                            ...
                            <span onclick="toggleFieldPassword('confirm_password', this)"
                                style="position: absolute; right: 12px; top: 50%; transform: translateY(-50%); cursor: pointer; color: #dc3545; display: inline-flex; align-items: center;">
                                <i class="fa-solid fa-eye" style="font-size: 14px;"></i>
                            </span>
                        </div>
...
<div id="placementModal" class="modal-overlay">
    <div class="modal-container" style="max-width: 750px;">
        <div class="modal-header">
            <h3><i class="fa-solid fa-user-tie"></i>
                <?php echo empty($placement['org_name']) ? 'Insert Site Supervisor Details' : 'Edit Placement Details'; ?>
            </h3>
        ...
        <div class="modal-body" style="max-height: calc(100vh - 200px); overflow-y: auto; padding-right: 8px;">
            <form action="" method="POST">
                <div class="org-info-card"
                    style="border: 1px solid #e2e8f0; border-radius: 6px; padding: 20px; background: #ffffff; margin-bottom: 20px;">
                    <h4
                        style="font-size: 15px; font-weight: 700; color: #1e293b; margin-bottom: 15px; border-bottom: 1.5px solid #cbd5e1; padding-bottom: 8px;">
                        <i class="fa-solid fa-building text-success" style="margin-right: 5px;"></i> Organization
                        details
                    </h4>
                    <div class="form-grid" style="grid-template-columns: 1fr 1fr; gap: 12px;">
                        <div class="form-group">
                            <label for="modal_org_name">Organization Name</label>
                            <input type="text" id="modal_org_name" name="org_name"
                                value="<?php echo htmlspecialchars($placement['org_name']); ?>" required
                ...
                <div class="org-info-card"
                    ...
                    <h4
                        style="font-size: 15px; font-weight: 700; color: #1e293b; margin-bottom: 15px; border-bottom: 1.5px solid #cbd5e1; padding-bottom: 8px;">
                        <i class="fa-solid fa-address-book" style="color: #3b82f6; margin-right: 5px;"></i> Organization
                        Contact Person
                    </h4>
                    <div class="form-grid" style="grid-template-columns: 1fr 1fr; gap: 12px;">
                        <div class="form-group">
                            <label for="modal_cp_name">Name</label>
                            <input type="text" id="modal_cp_name" name="contact_person_name"
                                value="<?php echo htmlspecialchars($placement['contact_person_name']); ?>" required
                                class="info-input-field" style="background-color: #fff; border: 1px solid #cbd5e1;">
                        </div>
                        <div class="form-group">
                            <label for="modal_cp_designation">Designation</label>
                            <input type="text" id="modal_cp_designation" name="contact_person_designation"
                                value="<?php echo htmlspecialchars($placement['contact_person_designation']); ?>"
                                required class="info-input-field"
                                style="background-color: #fff; border: 1px solid #cbd5e1;">
                        </div>
                        <div class="form-group">
                            <label for="modal_cp_phone">Cell No</label>
                            <input type="text" id="modal_cp_phone" name="contact_person_phone"
                                value="<?php echo htmlspecialchars($placement['contact_person_phone']); ?>" required
                                class="info-input-field" style="background-color: #fff; border: 1px solid #cbd5e1;">
                        </div>
                        <div class="form-group">
                            <label for="modal_cp_email">Email</label>
                            <input type="email" id="modal_cp_email" name="contact_person_email"
                                value="<?php echo htmlspecialchars($placement['contact_person_email']); ?>" required
                                class="info-input-field" style="background-color: #fff; border: 1px solid #cbd5e1;">
                        </div>
                    </div>
                </div>
                ...
                <div class="org-info-card"
                    ...
                    <h4
                        style="font-size: 15px; font-weight: 700; color: #1e293b; margin-bottom: 15px; border-bottom: 1.5px solid #cbd5e1; padding-bottom: 8px;">
                        <i class="fa-solid fa-user-tie" style="color: #f59e0b; margin-right: 5px;"></i> Site Supervisor
                        details
                    </h4>
                    <div class="form-grid" style="grid-template-columns: 1fr 1fr; gap: 12px;">
                        <div class="form-group">
                            <label for="modal_ss_name">Name</label>
                            <input type="text" id="modal_ss_name" name="site_supervisor_name"
                                value="<?php echo htmlspecialchars($placement['site_supervisor_name']); ?>" required
                                class="info-input-field" style="background-color: #fff; border: 1px solid #cbd5e1;">
                        </div>
                        <div class="form-group">
                            <label for="modal_ss_designation">Designation</label>
                            <input type="text" id="modal_ss_designation" name="site_supervisor_designation"
                                value="<?php echo htmlspecialchars($placement['site_supervisor_designation']); ?>"
                                required class="info-input-field"
                                style="background-color: #fff; border: 1px solid #cbd5e1;">
                        </div>
                        <div class="form-group">
                            <label for="modal_ss_phone">Cell No</label>
                            <input type="text" id="modal_ss_phone" name="site_supervisor_phone"
                                value="<?php echo htmlspecialchars($placement['site_supervisor_phone']); ?>" required
                                class="info-input-field" style="background-color: #fff; border: 1px solid #cbd5e1;">
                        </div>
                        <div class="form-group">
                            <label for="modal_ss_email">Email</label>
                            <input type="email" id="modal_ss_email" name="site_supervisor_email"
                                value="<?php echo htmlspecialchars($placement['site_supervisor_email']); ?>" required
                                class="info-input-field" style="background-color: #fff; border: 1px solid #cbd5e1;">
                        </div>
                    </div>
                </div>
                ...
                <div class="org-info-card"
                    ...
                    <h4
                        style="font-size: 15px; font-weight: 700; color: #1e293b; margin-bottom: 15px; border-bottom: 1.5px solid #cbd5e1; padding-bottom: 8px;">
                        <i class="fa-solid fa-briefcase" style="color: #6366f1; margin-right: 5px;"></i> Placed
                        Internship & Project
                    </h4>
                    <div class="form-grid" style="grid-template-columns: 1fr 1fr; gap: 12px;">
                        <div class="form-group">
                            <label for="modal_internship_title">Project Title</label>
                            <input type="text" id="modal_internship_title" name="internship_title"
                                value="<?php echo htmlspecialchars($placement['internship_title']); ?>" required
                                class="info-input-field" style="background-color: #fff; border: 1px solid #cbd5e1;">
                        </div>
                        <div class="form-group">
                            <label for="modal_duration_weeks">Duration (Weeks)</label>
                            <input type="number" id="modal_duration_weeks" name="duration_weeks"
                                value="<?php echo (int) $placement['duration_weeks']; ?>" required
                                class="info-input-field" style="background-color: #fff; border: 1px solid #cbd5e1;">
                        </div>
                    </div>
                </div>
                ...
                <div style="text-align: right; display: flex; gap: 10px; justify-content: flex-end;">
                    <button type="button" class="btn-cancel" onclick="closeModal('placementModal')"
                        style="margin-top: 0;">Cancel</button>
                    <button type="submit" name="save_placement_details" class="btn-submit"
                        style="margin-top: 0; background: linear-gradient(135deg, #10b981 0%, #059669 100%);">Save
